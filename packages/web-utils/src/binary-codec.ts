...
export function encodePayload(payload: any, compress = false): { data: Uint8Array; isGzip: boolean } {
...
export const encodeRows = (rows: any[], compress = false) => encodePayload(rows, compress);
