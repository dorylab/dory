...
export const artifacts = activeSchemas?.artifacts;
export const findings = activeSchemas?.findings;
export const findingArtifacts = activeSchemas?.findingArtifacts;
