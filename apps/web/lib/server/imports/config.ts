...
export function getImportConfig() {
    const maxFileBytes = positiveInteger('DORY_IMPORT_MAX_FILE_BYTES', 2_147_483_648);
    return {
        maxFileBytes,
        maxMaterializedBytes: positiveInteger('DORY_IMPORT_MAX_MATERIALIZED_BYTES', maxFileBytes),
