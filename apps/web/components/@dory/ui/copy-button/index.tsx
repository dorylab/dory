...
export const CopyButton = React.forwardRef<HTMLButtonElement, CopyButtonProps>(({ text, className, label, copiedLabel, timeout = 2000, ...buttonProps }, ref) => {
    ...
    return (
        <Button ref={ref} type="button" onClick={handleClick} className={className} {...buttonProps}>
