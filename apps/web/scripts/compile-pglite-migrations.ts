...
const migrationsFolder = path.resolve(__dirname, "../../../packages/database/src/pglite/migrations");

const outputPath = path.resolve(__dirname, "../../../packages/database/src/pglite/migrations.json");
